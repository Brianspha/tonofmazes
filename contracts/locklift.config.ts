  ...
  networks: {
    local: {
      ...
      keys: {
        ...
        phrase: "market lab spirit eagle chase hover crash crystal field whisper creek uniform",
        amount: 20,
      },
    },
    mainnet: {
    ...
    test: {
      ...
      giver: {
        giverFactory: (ever, keyPair, address) => new GiverWallet(ever, keyPair, address),
        address: "0:9387082f824c3d48b94827ab19a5ee4abf91b351b60eacb437fc07bdd92a5243",
        key: "ffcff30db90f76c47c1bbbb126b5e5c3aa12f5ed36f731518e715ba6e244fdc5",
      },
      tracing: {
      ...
      keys: {
        // Use everdev to generate your phrase
        // !!! Never commit it in your repos !!!
        phrase: process.env.PASS_PHRASE,
        amount: 20,
      },
    },
  },
